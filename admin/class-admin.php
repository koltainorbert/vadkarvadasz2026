    ...
    public static function render_shell(): void {
        ...
        <div id="va-sidebar">
            ...
            <nav class="va-sb-nav">
                ...
                <?php self::sb_item( "📋", "Hirdetések", admin_url( "admin.php?page=vadaszapro-listings" ), $page === "vadaszapro-listings" || $page === "vadaszapro-listing-edit" || $pt === "va_listing" || strpos( $scr_id, "va_listing" ) !== false, $pending > 0 ? (int)$pending : 0 ); ?>

                <?php if ( $auctions_enabled ): ?>
                <?php self::sb_item( "🔨", "Aukciók", admin_url( "edit.php?post_type=va_auction" ), $pt === "va_auction" || strpos( $scr_id, "va_auction" ) !== false ); ?>
                <?php endif; ?>
