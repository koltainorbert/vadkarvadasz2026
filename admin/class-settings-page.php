        ...
        <div class="wrap va-admin-wrap">
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    ...
                    <tr><td colspan="2"><p style="color:#aaa;margin:0 0 8px;">Ezek az oldalak ne jelenjenek meg a Google-ben (kerüljék az indexelést).</p></td></tr>
                    ...
                    <!-- ── Keresőmotor verifikáció ────────────── -->
                    <tr><th colspan="2" style="padding-top:18px;"><h2 style="margin:0;">✅ Keresőmotor verifikáció</h2></th></tr>
                    <tr><td colspan="2"><p style="color:#aaa;margin:0 0 8px;">Google/Bing Search Console meta tag verifikációs kód (csak a content="..." értéke).</p></td></tr>

                    <?php self::field_text( 'va_seo_google_verify', 'Google Search Console verifikációs kód' ); ?>
                    <?php self::field_text( 'va_seo_bing_verify',   'Bing Webmaster Tools verifikációs kód' ); ?>
