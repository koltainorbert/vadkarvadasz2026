...
class VA_Ajax {
    ...
    private static function get_category_required_rules(): array {
        return [
            ...
            'ejjellato-tavcso'  => [ 'label' => 'Éjjellátó távcső', 'required' => [ 'brand', 'model', 'optic_zoom', 'optic_objective' ] ],
            'hokamerak'         => [ 'label' => 'Hőkamerák', 'required' => [ 'brand', 'model', 'optic_zoom', 'optic_objective' ] ],
    ...
    public static function update_listing() {
        ...
        $job_role = sanitize_key( wp_unslash( $_POST['job_role'] ?? '' ) );
        $job_role_other = sanitize_text_field( wp_unslash( $_POST['job_role_other'] ?? '' ) );
        $job_county = intval( $_POST['job_county'] ?? 0 );
        $job_country = sanitize_text_field( wp_unslash( $_POST['job_country'] ?? '' ) );
        $job_education = sanitize_key( wp_unslash( $_POST['job_education'] ?? '' ) );
        $job_hunting_license = sanitize_key( wp_unslash( $_POST['job_hunting_license'] ?? '' ) );
        $job_firearm_license = sanitize_key( wp_unslash( $_POST['job_firearm_license'] ?? '' ) );
        $job_drivers_license = implode( ',', array_filter( array_map( 'sanitize_key', (array) wp_unslash( $_POST['job_drivers_license'] ?? [] ) ) ) );
        $job_experience = sanitize_key( wp_unslash( $_POST['job_experience'] ?? '' ) );
        $job_language = sanitize_text_field( wp_unslash( $_POST['job_language'] ?? '' ) );
        $job_dog_experience = sanitize_key( wp_unslash( $_POST['job_dog_experience'] ?? '' ) );
        $job_trophy_experience = sanitize_key( wp_unslash( $_POST['job_trophy_experience'] ?? '' ) );
        $job_tasks = sanitize_textarea_field( wp_unslash( $_POST['job_tasks'] ?? '' ) );
        $job_work_time = sanitize_key( wp_unslash( $_POST['job_work_time'] ?? '' ) );
        $job_accommodation = sanitize_key( wp_unslash( $_POST['job_accommodation'] ?? '' ) );
        $job_meals = sanitize_key( wp_unslash( $_POST['job_meals'] ?? '' ) );
        $job_company_vehicle = sanitize_key( wp_unslash( $_POST['job_company_vehicle'] ?? '' ) );
        $job_company_weapon = sanitize_key( wp_unslash( $_POST['job_company_weapon'] ?? '' ) );
        $job_salary_type = sanitize_key( wp_unslash( $_POST['job_salary_type'] ?? '' ) );
        $job_salary_min = sanitize_text_field( wp_unslash( $_POST['job_salary_min'] ?? '' ) );
        $job_salary_max = sanitize_text_field( wp_unslash( $_POST['job_salary_max'] ?? '' ) );
        $job_salary_currency = strtoupper( sanitize_text_field( wp_unslash( $_POST['job_salary_currency'] ?? '' ) ) );
        ...
        $accommodation_slot_mode = sanitize_key( wp_unslash( $_POST['accommodation_slot_mode'] ?? '' ) );
              ...
              'va_job_role' => $job_role,
              'va_job_role_other' => $job_role_other,
              'va_job_county' => $job_county,
              'va_job_country' => $job_country,
              'va_job_education' => $job_education,
              'va_job_hunting_license' => $job_hunting_license,
              'va_job_firearm_license' => $job_firearm_license,
              'va_job_drivers_license' => $job_drivers_license,
              'va_job_experience' => $job_experience,
              'va_job_language' => $job_language,
              'va_job_dog_experience' => $job_dog_experience,
              'va_job_trophy_experience' => $job_trophy_experience,
              'va_job_tasks' => $job_tasks,
              'va_job_work_time' => $job_work_time,
              'va_job_accommodation' => $job_accommodation,
              'va_job_meals' => $job_meals,
              'va_job_company_vehicle' => $job_company_vehicle,
              'va_job_company_weapon' => $job_company_weapon,
              'va_job_salary_type' => $job_salary_type,
              'va_job_salary_min' => $job_salary_min,
              'va_job_salary_max' => $job_salary_max,
              'va_job_salary_currency' => $job_salary_currency,
        ...
        $bow_acc_arrows = ! empty( $_POST['bow_acc_arrows'] ) ? '1' : '0';
        $bow_acc_case = ! empty( $_POST['bow_acc_case'] ) ? '1' : '0';
        $bow_acc_quiver = ! empty( $_POST['bow_acc_quiver'] ) ? '1' : '0';
        $bow_acc_target = ! empty( $_POST['bow_acc_target'] ) ? '1' : '0';
        ...
        $feed_game_boar = ! empty( $_POST['feed_game_boar'] ) ? '1' : '0';
        $feed_game_roe = ! empty( $_POST['feed_game_roe'] ) ? '1' : '0';
        $feed_game_red_deer = ! empty( $_POST['feed_game_red_deer'] ) ? '1' : '0';
        $feed_game_pheasant = ! empty( $_POST['feed_game_pheasant'] ) ? '1' : '0';
        $feed_game_other = ! empty( $_POST['feed_game_other'] ) ? '1' : '0';
