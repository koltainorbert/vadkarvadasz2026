...
.va-home-radar__spider#vhrSpiderWidget{position:relative;margin:0 0 10px !important;max-width:none !important;min-height:340px;overflow:hidden;border-color:rgba(120,190,255,.26);background:radial-gradient(circle at 50% 48%,rgba(65,155,255,.22),transparent 64%),linear-gradient(180deg,rgba(255,255,255,.05),rgba(255,255,255,.02));box-shadow:inset 0 0 0 1px rgba(120,190,255,.14),inset 0 0 34px rgba(80,180,255,.1),0 18px 28px rgba(0,0,0,.28);}
.va-home-radar__spider#vhrSpiderWidget::before{content:'';position:absolute;inset:-22% -10%;background:conic-gradient(from 0deg at 50% 50%,rgba(76,175,255,.2),rgba(76,175,255,0) 32%,rgba(76,175,255,.16) 54%,rgba(76,175,255,0) 78%,rgba(76,175,255,.2));filter:blur(8px);animation:va-radar-widget-rot 7.8s linear infinite;pointer-events:none;z-index:0;}
.va-home-radar__spider#vhrSpiderWidget::after{content:'';position:absolute;left:0;right:0;top:-24%;height:64%;background:linear-gradient(180deg,rgba(110,210,255,.0),rgba(110,210,255,.24),rgba(110,210,255,.0));mix-blend-mode:screen;animation:va-radar-widget-scan 3.2s ease-in-out infinite;pointer-events:none;z-index:0;}
.va-home-radar__spider#vhrSpiderWidget svg{position:relative;z-index:1;width:100% !important;max-height:336px;height:336px;display:block;}
.va-home-radar__spider#vhrSpiderWidget .vhr-grid{animation:va-radar-widget-grid 3.6s ease-in-out infinite;}
.va-home-radar__spider#vhrSpiderWidget .vhr-poly{animation:va-radar-widget-poly 1.7s ease-in-out infinite;}
.va-home-radar__spider#vhrSpiderWidget .vhr-dot{animation:va-radar-widget-dot 1.2s ease-in-out infinite;transform-origin:center center;}
@keyframes va-radar-widget-rot{from{transform:rotate(0deg);}to{transform:rotate(360deg);}}
@keyframes va-radar-widget-scan{0%{transform:translateY(-36%);}50%{transform:translateY(96%);}100%{transform:translateY(-36%);}}
@keyframes va-radar-widget-grid{0%,100%{opacity:.55;}50%{opacity:.9;}}
@keyframes va-radar-widget-poly{0%,100%{filter:drop-shadow(0 0 4px rgba(100,185,255,.35));}50%{filter:drop-shadow(0 0 14px rgba(100,185,255,.62));}}
@keyframes va-radar-widget-dot{0%,100%{transform:scale(1);}50%{transform:scale(1.16);}}
...
@media (max-width:640px){
  ...
  .va-home-radar__spider#vhrSpiderWidget{margin:2px 0 8px !important;}
  .va-home-radar__spider#vhrSpiderWidget{min-height:286px;}
  .va-home-radar__spider#vhrSpiderWidget svg{max-height:286px;height:286px;}
}
