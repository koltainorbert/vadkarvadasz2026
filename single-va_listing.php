    ...
    <div class="sl__layout">
        ...
        <div class="sl__right">
            ...
            $single_extra_fields = [
                ...
                'va_suppressor_type' => [ 'label' => 'Típus', 'type' => 'select', 'options' => [ 'menetes' => 'Menetes hangtompító', 'qd' => 'QD (quick detach)', 'integralt' => 'Integrált hangtompító', 'modularis' => 'Moduláris rendszer', 'vadasz' => 'Vadász hangtompító', 'sportlovesz' => 'Sportlövész hangtompító', 'taktikai' => 'Taktikai hangtompító', 'rimfire-22' => 'Rimfire (.22) hangtompító', 'egyeb' => 'Egyéb' ] ],
                'va_suppressor_thread_type' => [ 'label' => 'Menet / csatlakozás', 'type' => 'select', 'options' => [ 'm14x1' => 'M14x1', 'm15x1' => 'M15x1', 'm18x1' => 'M18x1', '1-2x20-unf' => '1/2x20 UNF', '1-2x28-unef' => '1/2x28 UNEF', '5-8x24' => '5/8x24', 'egyedi' => 'Egyedi' ] ],
                'va_suppressor_mount_type' => [ 'label' => 'Szerelés típusa', 'type' => 'select', 'options' => [ 'menetes' => 'Menetes', 'qd' => 'QD', 'egyedi' => 'Egyedi' ] ],
                'va_suppressor_caliber_compatibility' => [ 'label' => 'Kaliber kompatibilitás', 'type' => 'checkboxes', 'options' => [ '17-22' => '.17 - .22', '223-rem' => '.223 Rem', '243-win' => '.243 Win', '6-5-creedmoor' => '6.5 Creedmoor', '7x64-7x65r' => '7x64 / 7x65R', '308-win' => '.308 Win', '30-06' => '.30-06', '300-win-mag' => '.300 Win Mag', 'shotgun-12ga' => 'Shotgun 12ga', 'egyeb' => 'Egyéb' ] ],
                'va_suppressor_material' => [ 'label' => 'Anyag', 'type' => 'select', 'options' => [ 'aluminium' => 'Alumínium', 'repulogep-aluminium' => 'Repülőgép alumínium', 'titan' => 'Titán', 'rozsdamentes-acel' => 'Rozsdamentes acél', 'acel' => 'Acél', 'kombinalt' => 'Kombinált' ] ],
                'va_suppressor_build_type' => [ 'label' => 'Felépítés', 'type' => 'select', 'options' => [ 'monolit' => 'Monolit', 'modularis' => 'Moduláris', 'szetszedheto' => 'Szétszedhető', 'tobbkamras' => 'Többkamrás' ] ],
                'va_suppressor_regulation' => [ 'label' => 'Jogi státusz', 'type' => 'select', 'options' => [ 'engedelykoteles' => 'Engedélyköteles', 'atiras-koteles' => 'Átírás köteles', 'csak-fegyverrel' => 'Csak fegyverrel együtt', 'eu-kompatibilis' => 'EU kompatibilitás' ] ],
                'va_suppressor_noise_reduction_db' => [ 'label' => 'Zajcsökkentés (dB)', 'type' => 'text' ],
                'va_suppressor_recoil_reduction' => [ 'label' => 'Visszarúgás csökkentés', 'type' => 'text' ],
                'va_suppressor_flash_reduction' => [ 'label' => 'Csőtorkolat villanás csökkentés', 'type' => 'text' ],
                'va_suppressor_length_mm' => [ 'label' => 'Hossz (mm)', 'type' => 'text' ],
                'va_suppressor_diameter_mm' => [ 'label' => 'Átmérő (mm)', 'type' => 'text' ],
