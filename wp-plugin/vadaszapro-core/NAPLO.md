...
## 2026. 05. 27. – Session #allas-jogositvany-meretfix
- Kérés: a jogosítvány mező ne legyen túl széles.
...
### Igeny
- Az egyedi csomagnál a napos mező ne állítson semmit.
- A lejáratot kizárólag a naptárból lehessen meghatározni.
- A naptár legyen sötét/fekete, jól olvasható.

### Megvalositas [x]
- [x] `admin/class-settings-page.php`:
  - eltűnt a működő `Egyedi lejárat (nap a mai naptól)` mező,
  - maradt a `Lejárat dátuma` naptár,
  - a `datetime-local` input fekete stílust kapott (`#060606`, fehér szöveg, piros keret),
  - a mentés JS-ből már nem megy `custom_duration_days`.

- [x] `includes/class-user-roles.php`:
  - a custom lejárat mentésénél már nem számolunk napokból,
  - csak a dátum mező (`custom_expires_at`) számít,
  - ha nincs dátum, az egyedi csomag is 365 napos alap lejárati információval indul.

### Eredmeny
- A lejárat most egyértelműen a naptárból vezérelhető.
- A napos mező nem tud félrevezetni vagy felülírni semmit.
