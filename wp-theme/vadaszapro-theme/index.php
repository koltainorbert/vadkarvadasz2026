...
.vhr-bandcard__titlewrap{display:flex;align-items:center;gap:14px;}
.vhr-bandcard__logo{width:34px;height:34px;object-fit:contain;border-radius:6px;filter:drop-shadow(0 0 8px rgba(255,90,60,.35));}
.vhr-bandcard__title{font-size:1.2rem;letter-spacing:.14em;text-transform:uppercase;color:rgba(255,255,255,.82);font-weight:900;}
