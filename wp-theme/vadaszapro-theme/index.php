...
<section class="va-home-radar" id="va-home-radar" data-risk="low">
  ...
  <div class="va-home-radar__hero">
    <div class="va-home-radar__scorebox">
      <div class="va-home-radar__scorelabel">Országos max napi kár</div>
    ...
    <div class="va-home-radar__modal-card" role="dialog" aria-modal="true" aria-labelledby="vhrModalTitle">
      ...
      <div class="va-home-radar__modal-scroll" id="vhrModalScroll">
        ...
        <div class="va-home-radar__detail-grid">
          ...
          <label class="va-home-radar__field">
            <span>Tábla perem takarása</span>
            <select id="vhrEdgeCover">
              <option value="open">Nyílt</option>
              <option value="patchy">Részben takart</option>
              <option value="dense">Sűrű takarás</option>
            </select>
          </label>
          <label class="va-home-radar__field">
            <span>Dagonya / sárfolt</span>
            <select id="vhrWallow">
              <option value="none">Nincs</option>
              <option value="old">Régi nyom</option>
              <option value="fresh">Friss</option>
            </select>
          </label>
          <label class="va-home-radar__field">
            <span>Sózó / ásványi nyaló</span>
            <select id="vhrSalt">
              <option value="0">Nincs</option>
              <option value="1">Van 500 m-en belül</option>
            </select>
          </label>
          <label class="va-home-radar__field">
            <span>Vadkamera aktivitás</span>
            <select id="vhrCamera">
              <option value="none">Nincs adat</option>
              <option value="weekly">Heti 1-2 észlelés</option>
              <option value="daily">Napi aktivitás</option>
            </select>
          </label>
          <label class="va-home-radar__field">
            <span>Emberi forgalom</span>
            <select id="vhrHumanTraffic">
              <option value="normal">Átlagos</option>
              <option value="low">Alacsony</option>
              <option value="high">Magas</option>
            </select>
          ...
          <label class="va-home-radar__field">
            <span>Kutya / ragadozónyom</span>
            <select id="vhrPredator">
              <option value="none">Nincs</option>
              <option value="occasional">Eseti</option>
              <option value="strong">Erős</option>
            </select>
          </label>
          <label class="va-home-radar__field">
          ...
          <label class="va-home-radar__field">
            <span>Nappali fekvőhely</span>
            <select id="vhrDayBed">
              <option value="far">Távol</option>
              <option value="mid">Közepes távolság</option>
              <option value="near">Nagyon közel</option>
            </select>
          </label>
          <label class="va-home-radar__field">
            <span>Friss ürülék</span>
            <select id="vhrDroppings">
              <option value="none">Nincs</option>
              <option value="old">Régebbi nyom</option>
              <option value="fresh">Friss</option>
            </select>
          </label>
          <label class="va-home-radar__field">
            <span>Rejtett vonulási sáv</span>
            <select id="vhrCoverLane">
              <option value="none">Nincs</option>
              <option value="partial">Részben takart</option>
              <option value="strong">Erős, folyamatos</option>
            </select>
          </label>
          <label class="va-home-radar__field">
            <span>Vadriasztás</span>
            <select id="vhrRepellent">
              <option value="none">Nincs</option>
              <option value="intermittent">Időszakos</option>
              <option value="active">Aktív, folyamatos</option>
            </select>
          </label>
          <label class="va-home-radar__field">
            <span>Táblaszéli kárjelek</span>
            <select id="vhrEdgeDamage">
              <option value="none">Nincs</option>
              <option value="scattered">Szórtan látszik</option>
              <option value="clear">Egyértelmű, erős</option>
            </select>
          </label>
        </div>
...
.va-home-radar__spider{width:100%;max-width:560px;margin:0 auto 4px;}
.va-home-radar__spider svg{width:100%;height:auto;display:block;overflow:visible;}
.va-home-radar__split{display:grid;grid-template-columns:minmax(0,1.3fr) minmax(280px,.9fr);gap:18px;align-items:start;margin-bottom:10px;}@media(max-width:500px){.va-home-radar__split{grid-template-columns:1fr;}}.va-home-radar__stats{display:flex;flex-direction:column;gap:8px;}.va-srs{background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:9px 11px;}.va-srs__h{font-size:.55rem;font-weight:900;letter-spacing:.1em;text-transform:uppercase;color:rgba(255,255,255,.45);margin-bottom:7px;}.va-srs__row{display:flex;align-items:center;gap:5px;margin-bottom:4px;}.va-srs__n{font-size:.6rem;font-weight:800;color:rgba(255,255,255,.65);width:22px;flex-shrink:0;}.va-srs__tr{flex:1;height:5px;border-radius:3px;background:rgba(255,255,255,.1);overflow:hidden;}.va-srs__fi{height:100%;border-radius:3px;transition:width .6s;}.va-srs__fi.is-low,.va-srs__spb.is-low{background:#4caf50;}.va-srs__fi.is-moderate,.va-srs__spb.is-moderate{background:#ff9800;}.va-srs__fi.is-high,.va-srs__spb.is-high{background:#ff6b00;}.va-srs__fi.is-very-high,.va-srs__spb.is-very-high{background:#ff3b2f;}.va-srs__fi.is-critical,.va-srs__spb.is-critical{background:#ff0000;}.va-srs__v{font-size:.62rem;font-weight:900;color:#ff3b2f;width:20px;text-align:right;flex-shrink:0;}.va-srs__spark{display:flex;align-items:flex-end;gap:3px;height:66px;}.va-srs__col{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;}.va-srs__spb{width:100%;border-radius:3px 3px 0 0;min-height:4px;}.va-srs__sd{font-size:.5rem;color:rgba(255,255,255,.45);margin-top:2px;}.va-srs__gsv{width:100%;height:auto;display:block;}
.va-srs__meta{display:flex;justify-content:space-between;gap:8px;flex-wrap:wrap;margin:-1px 0 8px;font-size:.53rem;letter-spacing:.06em;text-transform:uppercase;color:rgba(255,255,255,.64);}
.va-srs__meta b{color:#fff;font-weight:900;letter-spacing:.02em;}
.va-srs__spark{height:92px;gap:5px;align-items:flex-end;}
.va-srs__col{gap:3px;}
.va-srs__coltop{font-size:.5rem;line-height:1;font-weight:900;letter-spacing:.04em;color:rgba(255,255,255,.9);}
.va-srs__spb{border-radius:5px 5px 0 0;}
.va-srs__spv{font-size:.53rem;line-height:1;color:#fff;font-weight:800;}
.va-srs__sd{font-size:.5rem;line-height:1;color:rgba(255,255,255,.7);}
.va-srs__ss{font-size:.48rem;line-height:1;color:rgba(255,225,225,.78);font-weight:800;}
.va-srs__bench{margin-top:6px;display:flex;justify-content:space-between;gap:8px;font-size:.49rem;letter-spacing:.06em;text-transform:uppercase;color:rgba(255,255,255,.55);}
...
.va-home-radar__picker-title{margin:8px 0 14px;font-size:1.08rem;color:#fff !important;}
.va-home-radar__picker-options{display:grid;gap:10px;max-height:min(62vh,520px);overflow:auto;padding:2px 2px 0 0;}
...
@media (max-width:640px){.va-home-radar{padding:11px;border-radius:20px;}.va-home-radar__subtitle{max-width:none;}.va-home-radar__loc{max-width:100%;}.va-home-radar__picker{padding:6vh 10px 10px;}.va-home-radar__heatmap-head,.va-home-radar__heatmap-row{grid-template-columns:1fr;}.va-home-radar__heatmap-corner{display:none;}.va-home-radar__heatmap-day{text-align:left;padding-left:10px;}.va-home-radar__heatmap-label{margin-top:8px;}.va-home-radar__picker-btn{padding:11px 30px 11px 11px;font-size:.72rem;}.va-home-radar__field span{font-size:.54rem;letter-spacing:.07em;}.va-home-radar__status,.va-home-radar__loc{font-size:.55rem;}}

/* Visual refresh: cleaner card hierarchy + no overflow on mobile. */
.va-home-radar{padding:16px 14px 14px;border-radius:26px;border-color:rgba(255,70,70,.34);background:radial-gradient(130% 130% at 82% 8%,rgba(255,38,38,.18),transparent 44%),radial-gradient(120% 120% at 12% 100%,rgba(255,120,40,.12),transparent 48%),linear-gradient(155deg,rgba(6,6,6,.985),rgba(12,9,9,.98) 52%,rgba(22,12,10,.97) 100%);box-shadow:0 28px 62px rgba(0,0,0,.5),inset 0 0 0 1px rgba(255,255,255,.03),inset 0 0 46px rgba(255,20,20,.05);}
.va-home-radar__hero,.va-home-radar__meta,.va-home-radar__meta-item,.va-home-radar__controls,.va-home-radar__day,.va-home-radar__intel,.va-home-radar__reason{min-width:0;}
.va-home-radar__spider#vhrSpiderWidget{max-width:none;margin:0 0 12px;padding:12px 10px;border-radius:18px;border:1px solid rgba(255,255,255,.09);background:radial-gradient(circle at 50% 50%,rgba(255,70,70,.16),transparent 62%),linear-gradient(180deg,rgba(255,255,255,.05),rgba(255,255,255,.02));box-shadow:inset 0 0 0 1px rgba(255,255,255,.02),0 12px 26px rgba(0,0,0,.26);}
.va-home-radar__spider#vhrSpiderWidget svg{max-height:190px;}
.va-home-radar__loc{display:flex;align-items:center;justify-content:center;min-height:38px;width:100%;max-width:none;margin:0 0 12px;padding:8px 12px;border-radius:14px;letter-spacing:.06em;font-size:.6rem;line-height:1.35;white-space:normal;overflow:visible;text-overflow:clip;background:linear-gradient(135deg,rgba(255,255,255,.1),rgba(255,255,255,.03));border:1px solid rgba(255,255,255,.16);}
.va-home-radar__controls{grid-template-columns:repeat(3,minmax(0,1fr));gap:10px 9px;margin-bottom:13px;}
.va-home-radar__picker-btn{min-height:54px;border-radius:15px;padding:12px 34px 12px 12px;font-size:.76rem;}
.va-home-radar__hero{grid-template-columns:minmax(132px,156px) 1fr;gap:10px;}
.va-home-radar__scorebox{border-radius:20px;padding:15px 11px 13px;}
.va-home-radar__score{font-size:clamp(2rem,7.2vw,3.05rem);line-height:.95;}
.va-home-radar__level{font-size:.56rem;letter-spacing:.11em;line-height:1.3;}
.va-home-radar__meta{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;}
.va-home-radar__meta-item{padding:10px 9px 9px;border-radius:14px;}
.va-home-radar__meta-item strong{font-size:.82rem;line-height:1.3;}
.va-home-radar__intel{margin-bottom:9px;border-radius:15px;}
.va-home-radar__intel-line{font-size:.72rem;line-height:1.5;}
.va-home-radar__reason{font-size:.68rem;line-height:1.5;padding:10px 11px;border-radius:14px;}
.va-home-radar__days{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:11px;}
.va-home-radar__day{border-radius:14px;padding:9px 7px 8px;}
.va-home-radar__dayname{font-size:.52rem;}
.va-home-radar__dayscore{font-size:.95rem;}
.va-home-radar__dayspecies{font-size:.53rem;}
.va-home-radar__toggle{margin-top:13px;border-radius:14px;padding:12px 13px;font-size:.72rem;letter-spacing:.1em;}
@media (max-width:880px){
  .va-home-radar__controls{grid-template-columns:repeat(2,minmax(0,1fr));}
  .va-home-radar__meta{grid-template-columns:repeat(2,minmax(0,1fr));}
  .va-home-radar__days{grid-template-columns:repeat(2,minmax(0,1fr));}
}
@media (max-width:640px){
  .va-home-radar{padding:12px 11px;border-radius:22px;}
  .va-home-radar__spider#vhrSpiderWidget{padding:10px 8px;margin-bottom:10px;}
  .va-home-radar__spider#vhrSpiderWidget svg{max-height:158px;}
  .va-home-radar__loc{min-height:36px;margin-bottom:10px;font-size:.57rem;}
  .va-home-radar__controls{grid-template-columns:1fr;gap:9px;}
  .va-home-radar__hero{grid-template-columns:1fr;gap:9px;}
  .va-home-radar__scorebox{min-height:126px;}
  .va-home-radar__score{font-size:2.35rem;}
  .va-home-radar__meta{grid-template-columns:1fr;}
  .va-home-radar__days{grid-template-columns:repeat(2,minmax(0,1fr));}
}

/* Compact radar card: only radar image + biggest daily estimate on the closed widget. */
.va-home-radar__loc,
.va-home-radar__controls,
.va-home-radar__meta,
.va-home-radar__intel,
...
.va-home-radar__score{font-size:2.7rem !important;line-height:.95 !important;color:#fff;text-shadow:0 0 22px rgba(120,190,255,.35) !important;}
.va-home-radar__toggle{margin-top:10px !important;background:linear-gradient(135deg,#0b1f39 0%,#0a2749 48%,#4a1731 100%) !important;border-color:rgba(120,190,255,.34) !important;box-shadow:0 12px 28px rgba(0,130,255,.17), inset 0 0 20px rgba(255,80,80,.07) !important;}
@media (max-width:640px){
...
(function initRadar(){
  ...
  var edgeCoverEl=document.getElementById('vhrEdgeCover');
  var wallowEl=document.getElementById('vhrWallow');
  var saltEl=document.getElementById('vhrSalt');
  var cameraEl=document.getElementById('vhrCamera');
  var humanTrafficEl=document.getElementById('vhrHumanTraffic');
  var predatorEl=document.getElementById('vhrPredator');
  var nightLightEl=document.getElementById('vhrNightLight');
  var dayBedEl=document.getElementById('vhrDayBed');
  var droppingsEl=document.getElementById('vhrDroppings');
  var coverLaneEl=document.getElementById('vhrCoverLane');
  var repellentEl=document.getElementById('vhrRepellent');
  var edgeDamageEl=document.getElementById('vhrEdgeDamage');
  ...
  var spiderEl=document.getElementById('vhrSpider');
  var spiderWidgetEl=document.getElementById('vhrSpiderWidget');
  var spiderStatsEl=document.getElementById('vhrSpiderStats');
  ...
  function controls(){return {crop:cropEl.value,forest:forestEl.value,damage:damageEl.value,phenology:phenologyEl.value,hunting:huntingEl.value,fence:fenceEl.value==='1',forestFood:forestFoodEl.value,water:waterEl.value==='1',wind:windEl.value,track:trackEl.value,neighbor:neighborEl.value==='1',feeder:feederEl.value==='1',quiet:quietEl.value,gameStrip:gameStripEl.value==='1',exit:exitEl.value,edgeCover:edgeCoverEl.value,wallow:wallowEl.value,salt:saltEl.value==='1',camera:cameraEl.value,humanTraffic:humanTrafficEl.value,predator:predatorEl.value,nightLight:nightLightEl.value,dayBed:dayBedEl.value,droppings:droppingsEl.value,coverLane:coverLaneEl.value,repellent:repellentEl.value,edgeDamage:edgeDamageEl.value};}
  function applySpecializedModifiers(species,ctl,reasons){
    var delta=0;
    var deerLike=species==='red_deer'||species==='fallow_deer'||species==='roe_deer';
    if(ctl.edgeCover==='dense'){delta+=species==='wild_boar'?5:(deerLike?4:2);reasons.push('takart táblaszél');}
    else if(ctl.edgeCover==='patchy'){delta+=2;reasons.push('részben takart táblaszél');}
    else if(ctl.edgeCover==='open'){delta-=deerLike?2:1;}
    if(ctl.wallow==='fresh'&&species==='wild_boar'){delta+=7;reasons.push('friss dagonya/sárfolt');}
    else if(ctl.wallow==='old'&&species==='wild_boar'){delta+=3;reasons.push('régi dagonyahasználat');}
    if(ctl.salt){var saltAdd={red_deer:5,fallow_deer:5,roe_deer:3,wild_boar:2,wild_hare:1};delta+=(saltAdd[species]||1);reasons.push('sózó vagy ásványi nyaló közel');}
    if(ctl.camera==='daily'){delta+=species==='wild_boar'?6:(deerLike?5:3);reasons.push('napi vadkamera-aktivitás');}
    else if(ctl.camera==='weekly'){delta+=species==='wild_boar'?3:(deerLike?2:1);reasons.push('visszatérő vadkamera-aktivitás');}
    if(ctl.humanTraffic==='low'){delta+=4;reasons.push('alacsony emberi forgalom');}
    else if(ctl.humanTraffic==='high'){delta-=species==='wild_boar'?4:5;reasons.push('erős emberi forgalom');}
    if(ctl.predator==='strong'){delta-=deerLike||species==='wild_hare'?5:2;reasons.push('erős ragadozó/kutya nyomás');}
    else if(ctl.predator==='occasional'){delta-=deerLike||species==='wild_hare'?2:1;}
    if(ctl.nightLight==='strong'){if(species==='wild_boar'){delta-=4;reasons.push('erős éjszakai fényterhelés');}else{delta+=1;reasons.push('világos terepszakasz');}}
    else if(ctl.nightLight==='none'){delta+=species==='wild_boar'?2:1;}
    if(ctl.dayBed==='near'){delta+=species==='wild_boar'?6:(deerLike?5:3);reasons.push('közeli nappali fekvőhely');}
    else if(ctl.dayBed==='mid'){delta+=species==='wild_boar'?3:2;reasons.push('közepes távolságú nappali fekvőhely');}
    if(ctl.droppings==='fresh'){delta+=species==='wild_boar'?5:(deerLike?6:3);reasons.push('friss ürülék a táblánál');}
    else if(ctl.droppings==='old'){delta+=2;reasons.push('régebbi ürüléknyom');}
    if(ctl.coverLane==='strong'){delta+=species==='wild_boar'?5:(deerLike?4:2);reasons.push('rejtett vonulási sáv');}
    else if(ctl.coverLane==='partial'){delta+=2;reasons.push('részben takart vonulási sáv');}
    if(ctl.repellent==='active'){delta-=species==='wild_boar'?6:7;reasons.push('aktív vadriasztás');}
    else if(ctl.repellent==='intermittent'){delta-=3;reasons.push('időszakos vadriasztás');}
    if(ctl.edgeDamage==='clear'){delta+=species==='wild_boar'?6:(deerLike?5:3);reasons.push('egyértelmű táblaszéli kárjel');}
    else if(ctl.edgeDamage==='scattered'){delta+=3;reasons.push('szórt táblaszéli kárjelek');}
    return delta;
  }
  ...
  function scoreSpecies(species,ctx,ctl){
    var score=(speciesBase[species]||4)+((cropScores[ctl.crop]&&cropScores[ctl.crop][species])||0)+(forestScores[ctl.forest]||0)+(damageScores[ctl.damage]||0)+((((phenologyScores[ctl.crop]||{})[ctl.phenology]||{})[species])||0)+((huntingScores[ctl.hunting]&&huntingScores[ctl.hunting][species])||0);
    var reasons=[];
    if((forestScores[ctl.forest]||0)>0){reasons.push('erdőközeli kijárás');}
    if((damageScores[ctl.damage]||0)>0){reasons.push('friss kárelőzmény');}
    reasons.push((cropLabels[ctl.crop]||ctl.crop)+' vonzó táplálék');
    if((((phenologyScores[ctl.crop]||{})[ctl.phenology]||{})[species])>0){reasons.push('aktuális fenológia erős kiváltó ok');}
    if(ctl.fence){score-=15;}
    if(forestFoodScores[ctl.forestFood]){var ffs=forestFoodScores[ctl.forestFood][species]||0;score+=ffs;if(ctl.forestFood==='scarce'&&ffs>0){reasons.push('szegényes erdei táplálék, mező felé kényszerül');}else if(ctl.forestFood==='abundant'&&ffs<0){reasons.push('bő erdei makk/gyümölcs, erdőben marad');}}
    if(ctl.water&&species==='wild_boar'){score+=6;reasons.push('vizes élőhely közel (+6)');}
    if(ctl.water&&(species==='red_deer'||species==='fallow_deer')){score+=3;reasons.push('vizes élőhely közel (+3)');}
    var windBonus={headwind:-4,crosswind:0,tailwind:4};
    score+=windBonus[ctl.wind]||0;
    if(ctl.wind==='tailwind'){reasons.push('hátszél – állat nem szagolja a jelenlétet');}
    else if(ctl.wind==='headwind'){reasons.push('szembeszél – állat hamar szagol');}
    if(ctl.track==='fresh'){score+=9;reasons.push('friss vadcsapás/nyom (<24h)');}
    else if(ctl.track==='old'){score+=3;reasons.push('régi nyom – sporadikus kijárás');}
    if(ctl.neighbor){var nba=species==='roe_deer'?6:(species==='wild_boar'?5:4);score+=nba;reasons.push('szomszéd tábla betakarítva – állatok átnyomulnak');}
    if(ctl.feeder){var fda={wild_boar:5,red_deer:4,roe_deer:2,fallow_deer:4,wild_hare:1};score+=(fda[species]||2);reasons.push('etetőhely/dögkút vonzza az állatokat');}
    if(ctl.quiet==='quiet'){score+=5;reasons.push('csendes időszak – bátran jár ki');}
    else if(ctl.quiet==='disturbed'){score-=4;reasons.push('közeli zavarás – kerülő úton jár');}
    if(ctl.gameStrip){score+=3;reasons.push('vadföld megszokott táplálkozási zóna');}
    var exitAdd={unknown:0,forest_edge:2,reed:(species==='wild_boar'?5:2),ditch:(species==='wild_boar'?3:(species==='wild_hare'?1:2))};
    score+=(exitAdd[ctl.exit]||0);
    if(ctl.exit==='reed'){reasons.push('nádas kijárási irány – jó fedezék');}
    else if(ctl.exit==='forest_edge'){reasons.push('erdőszélről érkezik');}
    else if(ctl.exit==='ditch'){reasons.push('vizesárok mentén vonul');}
    score+=applySpecializedModifiers(species,ctl,reasons);
    if(species==='wild_boar'&&ctx.precip48>5&&ctx.soil>0.18){score+=5;reasons.push('eső utáni puha talaj');}
    if(species==='wild_boar'&&ctx.tempNight>12&&ctx.humidity>75){score+=4;reasons.push('meleg, párás éjszaka');}
    if((species==='red_deer'||species==='roe_deer'||species==='fallow_deer'||species==='wild_hare')&&ctx.tempMin<=2&&(ctl.crop==='rapeseed'||ctl.crop==='cereal'||ctl.crop==='alfalfa')){score+=4;reasons.push('hidegben felértékelődő zöld kultúra');}
    if(ctx.wind>30){score-=5;}
    else if(ctx.wind<8){score+=2;reasons.push('szélcsend');}
    if(ctx.pressureDrop<=-5){score+=3;reasons.push('front előtti nyomásesés');}
    if(ctx.rainSum>6){score+=2;reasons.push('csapadék utáni mozgás');}
    var effMoon=ctx.moon*(1-(ctx.cloud/100));
    if(species==='wild_boar'){if(effMoon>0.6&&ctl.hunting!=='low'){score-=1;}if(effMoon>0.9&&ctl.hunting==='high'){score-=1;}}
    else if(effMoon>0.9){score+=2;reasons.push('erős holdfény');}
    if(ctl.fence){reasons.push('villanypásztor fékezi a kijárást');}
  ...
  function renderWidgetBandCard(ctx,ctl){
    if(!spiderWidgetEl){return;}
    var sps=Object.keys(speciesMeta),rows=sps.map(function(sp){
      var s=scoreSpecies(sp,ctx,ctl).score;
      return {species:sp,score:s};
    ...
    html+='<div class="vhr-bandcard__rows">'+rows.map(function(row){
      return '<div class="vhr-bandcard__row">'
        ...
        +'<div class="vhr-bandcard__bar"><div class="vhr-bandcard__fill" style="width:'+row.score+'%"></div></div>'
        +'<div class="vhr-bandcard__value">'+row.score+'/100</div>'
      +'</div>';
    }).join('')+'</div>';
    html+='<div class="vhr-bandcard__footer">Élő számolt index • órás meteo + helyi tényezők</div>';
    html+='</div>';
    spiderWidgetEl.innerHTML=html;
  }
  function renderSpider(ctx,ctl,target){var el=target||spiderEl;if(!el)return;var isWidget=el===spiderWidgetEl;var sps=Object.keys(speciesMeta),n=sps.length,cx=isWidget?170:250,cy=isWidget?182:210,mR=isWidget?126:126,labelOffset=isWidget?30:48,viewBox=isWidget?'0 0 360 360':'0 0 520 420';function ang(i){return(2*Math.PI*i/n)-Math.PI/2;}function pt(i,v){var a=ang(i),r=mR*(v/100);return{x:cx+r*Math.cos(a),y:cy+r*Math.sin(a)};}var g='';[20,40,60,80,100].forEach(function(lv,gi){var pts=sps.map(function(_,i){var p=pt(i,lv);return p.x+','+p.y;}).join(' ');g+='<polygon class="'+(isWidget?'vhr-grid':'')+'" points="'+pts+'" fill="none" stroke="rgba(255,255,255,'+(gi===4?'.2':'.07')+')" stroke-width="1"/>';});var ax=sps.map(function(_,i){var p=pt(i,100);return '<line x1="'+cx+'" y1="'+cy+'" x2="'+p.x+'" y2="'+p.y+'" stroke="rgba(255,255,255,.13)" stroke-width="1"/>';}).join('');var scores=sps.map(function(sp){return scoreSpecies(sp,ctx,ctl).score;});var dp=scores.map(function(s,i){var p=pt(i,s);return p.x+','+p.y;}).join(' ');var poly='<polygon class="'+(isWidget?'vhr-poly':'')+'" points="'+dp+'" fill="rgba(58,150,255,.24)" stroke="rgba(95,180,255,.96)" stroke-width="'+(isWidget?'2.4':'2.6')+'" stroke-linejoin="round"/>';var dots=scores.map(function(s,i){var p=pt(i,s),r=isWidget?6:6;return '<circle class="'+(isWidget?'vhr-dot':'')+'" cx="'+p.x+'" cy="'+p.y+'" r="'+r+'" fill="#63a9ff" data-sp="'+sps[i]+'" data-score="'+s+'" stroke="rgba(0,0,0,.4)" stroke-width="1.5" style="cursor:pointer"/>';}).join('');var labs=sps.map(function(sp,i){var a=ang(i),lp=pt(i,100),ox=Math.cos(a)*labelOffset,oy=Math.sin(a)*labelOffset,lx=lp.x+ox,ly=lp.y+oy,anc=lx<cx-8?'end':(lx>cx+8?'start':'middle'),s=scores[i],nameSize=isWidget?12.5:14,scoreSize=isWidget?20:28;return '<text x="'+lx+'" y="'+(ly-4)+'" text-anchor="'+anc+'" font-size="'+nameSize+'" font-weight="700" font-family="sans-serif" fill="rgba(255,255,255,.8)">'+speciesMeta[sp].label+'</text><text x="'+lx+'" y="'+(ly+22)+'" text-anchor="'+anc+'" font-size="'+scoreSize+'" font-weight="900" font-family="sans-serif" fill="#63a9ff">'+s+'</text>';}).join('');el.innerHTML='<svg viewBox="'+viewBox+'" xmlns="http://www.w3.org/2000/svg">'+g+ax+poly+dots+labs+'</svg>';el.querySelectorAll('circle[data-sp]').forEach(function(c){c.addEventListener('mouseenter',function(){c.setAttribute('r',isWidget?'9':'9');c.style.filter='drop-shadow(0 0 7px #63a9ff)';});c.addEventListener('mouseleave',function(){c.setAttribute('r',isWidget?'6':'6');c.style.filter='';});c.addEventListener('click',function(){var all=el.querySelectorAll('circle[data-sp]');all.forEach(function(cc){cc.setAttribute('opacity','0.3');});c.setAttribute('opacity','1');setTimeout(function(){all.forEach(function(cc){cc.setAttribute('opacity','1');});},700);});});}
  function renderSpiderStats(forecast,top){if(!spiderStatsEl)return;var sps=Object.keys(speciesMeta),ctl=controls(),scores=sps.map(function(sp){return scoreSpecies(sp,top.ctx,ctl).score;});var b1='<div class="va-srs"><div class="va-srs__h">Fajok kockázata</div>'+sps.map(function(sp,i){var s=scores[i],lv=riskLevel(s);return '<div class="va-srs__row"><span class="va-srs__n">'+speciesMeta[sp].short+'</span><div class="va-srs__tr"><div class="va-srs__fi is-'+lv.cls+'" style="width:'+s+'%"></div></div><span class="va-srs__v">'+s+'</span></div>';}).join('')+'</div>';var days=forecast.slice(0,7),todayScore=days.length?days[0].score:0,avgScore=days.length?Math.round(days.reduce(function(sum,day){return sum+day.score;},0)/days.length):0,b2='<div class="va-srs"><div class="va-srs__h">7 napos trend</div><div class="va-srs__meta"><span>Alap: mai csucsindex <b>'+todayScore+'/100</b></span><span>7 nap atlag <b>'+avgScore+'/100</b></span></div><div class="va-srs__spark">'+days.map(function(day){var d=new Date(day.day+'T12:00:00'),lv=riskLevel(day.score),h=Math.max(8,Math.round(day.score*0.72)),delta=day.score-todayScore,deltaTxt=(delta>0?'+':'')+delta,hue=Math.max(0,Math.min(120,120-Math.round(day.score*1.2)));return '<div class="va-srs__col"><span class="va-srs__coltop is-'+lv.cls+'">'+deltaTxt+'</span><div class="va-srs__spb" style="height:'+h+'px;background:linear-gradient(180deg,hsl('+hue+',95%,58%),hsl('+hue+',88%,42%));"></div><span class="va-srs__spv">'+day.score+'</span><span class="va-srs__sd">'+dayName(d.getDay()).slice(0,1)+'</span><span class="va-srs__ss">'+speciesMeta[day.species].short+'</span></div>';}).join('')+'</div><div class="va-srs__bench"><span>Skala: 0-100</span><span>Napi fo faj roviditve</span></div></div>';spiderStatsEl.innerHTML=b1+b2;}
  ...
  [edgeCoverEl,wallowEl,saltEl,cameraEl,humanTrafficEl,predatorEl,nightLightEl,dayBedEl,droppingsEl,coverLaneEl,repellentEl,edgeDamageEl].forEach(function(selectEl){selectEl.addEventListener('change',function(){syncPickerButton(selectEl);rerender();});});
